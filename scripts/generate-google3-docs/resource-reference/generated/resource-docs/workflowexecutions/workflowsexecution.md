...
apiVersion: workflowexecutions.cnrm.cloud.google.com/v1beta1
kind: WorkflowsExecution
metadata:
  name: workflowexecution-sample
spec:
  argument: "{\"var1\":\"value1\",\"var2\":\"value2\"}"
  # Can be one of "LOG_ALL_CALLS", "LOG_ERRORS_ONLY", "LOG_ERRORS_ONLY", "CALL_LOG_LEVEL_UNSPECIFIED"
  # Will override the Workflow's callLogLevel for this execution only
  ...
  projectRef:
    ...
    external: ${PROJECT_ID?}
  workflowRef:
    external: projects/${projectId}/locations/us-central1/workflows/workflowexecution-dep
---
apiVersion: workflows.cnrm.cloud.google.com/v1beta1
kind: WorkflowsWorkflow
metadata:
  name: workflowexecution-dep
spec:
  location: us-central1
  projectRef:
    # Replace ${PROJECT_ID?} with your project ID
